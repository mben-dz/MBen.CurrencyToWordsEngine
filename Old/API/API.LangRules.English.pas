...
function TEnglishRules.GetLangCode: string; begin Result := 'en'; end;
...
function TEnglishRules.CombineTens(const aTens, aUnits: string; aNumber: Integer): string;
begin
  if aUnits = '' then
    Result := aTens else
    Result := aTens + '-' + aUnits;
